...
import random
from .backbone.common import initialize_weights, Flatten, SEModule
...
class Backbone(Module):
    def __init__(self, input_size, num_layers, mode='ir'):
        ...
        self.input_layer = Sequential(Conv2d(108, 64, (3, 3), 1, 1, bias=False),
    ...
    def _images_to_dct(self,x, size=8, stride=8, pad=0, dilation=1):
        ...
        # channels = list(set(channels) - set(sampled_channels))
        random_seed = 42
        random.seed(random_seed)
        channels=random.sample(channels, 36)
