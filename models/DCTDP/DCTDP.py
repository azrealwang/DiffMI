...
def DCTDP_model():
    ...
    pth_files = ["checkpoints/dctdp_Backbone_Epoch_24_checkpoint.pth", "checkpoints/dctdp_HEAD_Epoch_24_Split_0_checkpoint.pth", "checkpoints/dctdp_META_Epoch_24_checkpoint.pth"]
